...
export default function BudgetsPage() {
  return (<div style={{ padding: "var(--space-8)", maxWidth: 900 }}>
    ...
    <div style={{ display: "flex", flexDirection: "column", gap: "var(--space-4)" }}>
      {budgets.map(b => (<Card key={b.name} padding="lg" className={b.alert && b.pct > 100 ? "budget-exceeded" : ""}>
        <div style={{ border: b.alert && b.pct > 100 ? "1px solid var(--color-error)" : "none", borderRadius: "var(--radius-md)", padding: b.alert && b.pct > 100 ? "var(--space-4)" : "0" }}>
